...
SRCREV = "f83695864f21e3d478207b2bce1a2c200d43367f"
...
do_install_append() {
    # by upstream libfuse design, the v3 initscripts, udev rules and conf files
    # should be also used for v2 via the fuse-common package (they guarantee
    # backwards compatibility) so rename 'fuse3' -> 'fuse' for parity
    mv ${D}${sysconfdir}/init.d/${PN} ${D}${sysconfdir}/init.d/fuse
    mv ${D}${libdir}/udev/rules.d/99-${PN}.rules ${D}${libdir}/udev/rules.d/99-fuse.rules
